 ...
 *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
 ...
 .archive-divider:hover { color: #111827; }
 ...
 .birthday-chip {
   display: flex; align-items: center; gap: 10px;
   padding: 8px 12px; background: #FFFFFF; border: 1px solid #D8DCF0;
   border-radius: 10px; font-size: 13px; color: #111827;
 }
 .birthday-chip:hover { border-color: rgba(99,57,255,0.25); }
...
// Extrai ID do YouTube com regex robusta
const getYtId = url => {
if (!url) return null;
